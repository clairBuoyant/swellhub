...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Feedback":
			resolverName, err := entityResolverNameForFeedback(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Feedback": %w`, err)
			}
			switch resolverName {
			...
			case "findFeedbackByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findFeedbackByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindFeedbackByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Feedback": %w`, err)
				}
...
func entityResolverNameForFeedback(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findFeedbackByID", nil
	}
	return "", fmt.Errorf("%w for Feedback", ErrTypeNotFound)
}
